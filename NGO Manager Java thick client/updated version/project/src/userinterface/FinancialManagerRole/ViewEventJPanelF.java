...
public class ViewEventJPanelF extends javax.swing.JPanel {
     ...
     */
    public ViewEventJPanelF(JPanel userProcessContainer, EventWorkRequest wr,UserAccount ua) {
        initComponents();
   ...
   private boolean validateData()
    {
        if(!(jTextFieldEventName.getText().trim().length() > 0)){
           ...
           JOptionPane.showMessageDialog(null,"Estimated Budget should be greater than zero and not null","Warning",JOptionPane.WARNING_MESSAGE);
            return false;
        }
    ...
    private void initComponents() {
        ...
        add(saveJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(624, 645, 196, 54));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(412, 11, -1, -1));
        ...
        add(updateJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(208, 645, 208, 54));

        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Street Address:");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 536, -1, -1));

        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("City :");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 591, -1, -1));

        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Zip Code :");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 591, -1, -1));

        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("State :");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 591, -1, -1));
        ...
        add(jTextFieldEventDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(322, 156, 329, -1));
        add(jTextFieldStartTime, new org.netbeans.lib.awtextra.AbsoluteConstraints(352, 215, 299, -1));
        add(jTextFieldDuration, new org.netbeans.lib.awtextra.AbsoluteConstraints(352, 283, 299, -1));
        add(jTextFieldBudget, new org.netbeans.lib.awtextra.AbsoluteConstraints(352, 350, 299, -1));
        add(jTextFieldVolunteers, new org.netbeans.lib.awtextra.AbsoluteConstraints(322, 417, 329, -1));
        add(jTextFieldStreetAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(235, 533, 835, -1));
        add(jTextFieldCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(104, 588, 413, -1));
        add(jTextFieldZip, new org.netbeans.lib.awtextra.AbsoluteConstraints(658, 588, 114, -1));
        add(jTextFieldState, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 588, 200, -1));

        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Event Name :");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(115, 102, -1, -1));

        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Event Description :");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(52, 159, -1, -1));
        add(jDateChooserEventDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 100, -1, -1));

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Start Time :");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(134, 218, -1, -1));

        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Duration :");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 286, -1, -1));
        add(jDateChooserRequiredDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 160, -1, -1));

        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Required Date");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 160, -1, -1));

        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Location :");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(159, 484, -1, -1));
        ...
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(49, 353, -1, -1));

        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Volunteers Required :");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(18, 420, -1, -1));
        add(jTextFieldEventName, new org.netbeans.lib.awtextra.AbsoluteConstraints(322, 99, 329, -1));

        jLabel18.setForeground(new java.awt.Color(255, 255, 255));
        jLabel18.setText("Affiliated Company:");
        add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 240, -1, -1));
        ...
        add(jComboBoxAffiliatedCompany, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 240, 170, -1));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/AdministrativeRole/Green.PNG"))); // NOI18N
        add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(-3, 0, 1250, 750));
